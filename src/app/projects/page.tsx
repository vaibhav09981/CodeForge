  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100 p-4 w-full">
      ...
      <div className="grid grid-cols-1 gap-8 w-full max-w-4xl">
        {/* DSA Visualizer Card */}
        <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col md:flex-row items-center md:items-start text-center md:text-left" style={{ backgroundColor: '#f0f4f8' }}>
          <div className="md:w-1/2 md:pr-4">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2"><span style={{ backgroundColor: '#bfff00', padding: '0 5px', borderRadius: '3px' }}>DSA Visualizer</span></h2>
        ...
        {/* Stream UI Card */}
        <div className="bg-white rounded-2xl shadow-md p-6 flex flex-col md:flex-row items-center md:items-start text-center md:text-left mt-8" style={{ backgroundColor: '#f0f4f8' }}>
          <div className="md:w-1/2 md:pr-4">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2"><span style={{ backgroundColor: '#bfff00', padding: '0 5px', borderRadius: '3px' }}>StreamUI</span></h2>
            <p className="text-gray-700 mb-4 text-sm">
